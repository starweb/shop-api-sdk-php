...
class OrderModelNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        elseif (property_exists($data, 'paymentMethodExternalId') && $data->{'paymentMethodExternalId'} === null) {
        ...
        elseif (property_exists($data, 'shippingMethodExternalId') && $data->{'shippingMethodExternalId'} === null) {
